...
wget http://freenetproject.org/snapshots/freenet-latest.jar -O freenet-latest.jar
if test -s freenet-latest.jar; then
    mv -f freenet-latest.jar freenet.jar
fi
wget http://freenetproject.org/snapshots/seednodes.ref.bz2 -O new-seednodes.ref.bz2
