   ...
   <td bgcolor="#f3f3f3" align="left" width="100%" class="content">
    <table class="ocmPeerData">
      <tr>
        ...
        <td class="inbound">##DATATRANSFERRED##</td>
        <th>Routing&nbsp;Information</th>
      </tr>
      <tr>
        <td colspan="2"><img height="4" width="##DATATRANSFERREDBARLENGTH##" src="##DISTKEY##/servlet/coloredpixel?color=252597"></td>
      ...
      <tr>
        ...
        <td class="inbound">##MESSAGESTRANSFERRED##</td>
      </tr>
      <tr style="height:3px">
        <td colspan="2"><img height="4" width="##DATATRANSFERREDBARLENGTH##" src="##DISTKEY##/servlet/coloredpixel?color=252597"></td>
      </tr>
      ...
      <tr style="height:3px">
        <td colspan="2"><img height="4" width="##REQUESTSOUTBOUNDBARLENGTH##" src="##DISTKEY##/servlet/coloredpixel?color=7810D0"></td>
      </tr>
      <tr style="height:3px">
        <td colspan="2"><img height="4" width="##REQUESTSINBOUNDBARLENGTH##" src="##DISTKEY##/servlet/coloredpixel?color=252597"></td>
      </tr>
    </table>
   </td>
