<div class="box">
  ...
  <div class="content">
    <table class="ocmPeerData">
      ...
      <tr>
        <td colspan="2"><div class="horizontalBar outboundbackground" style="width:##REQUESTSOUTBOUNDBARLENGTH##px" /></td>
      </tr>
      <tr>
        <td colspan="2"><div class="horizontalBar inboundbackground" style="width:##REQUESTSINBOUNDBARLENGTH##px" /></td>
      </tr>
